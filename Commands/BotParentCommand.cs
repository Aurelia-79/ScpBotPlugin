...
public class BotParentCommand : ParentCommand
{
    ...
    /// <inheritdoc />
    public override string Description => "机器人管理命令。子命令：spawn / spawnpos / follow / kill / list / status / room / path / wp / respawn";
    ...
    public override void LoadGeneratedCommands()
    {
        ...
        RegisterCommand(new BotStatusCommand());
    ...
    {
        response = "用法: bot <spawn|spawnpos|follow|kill|list|status|room|path|wp|respawn> [参数]";
        return false;
    }
}
